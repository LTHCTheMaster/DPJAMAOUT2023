...
function arachneas:init/_intern/sub_parts/generate_compass/generate_location_with_maps/coordinates_manipulation/check_surround/p2/from_first_village
function arachneas:init/_intern/sub_parts/generate_compass/generate_location_with_maps/coordinates_manipulation/check_surround/p2/from_second_village
function arachneas:init/_intern/sub_parts/generate_compass/generate_location_with_maps/coordinates_manipulation/check_surround/p2/from_third_village
