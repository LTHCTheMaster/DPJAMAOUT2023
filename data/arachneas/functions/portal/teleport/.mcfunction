...
execute if entity @e[type=marker,distance=..4,tag=arachneas.portal,tag=arachneas.has_equivalent] run tag @s add arachneas.has_equivalent
tag @e[type=marker,distance=..4,tag=arachneas.portal,tag=!arachneas.has_equivalent] add arachneas.has_equivalent
